...
//    }
//
//    public static  void getDataGif$default(GifTransitionViewModel gifTransitionViewModel, String str, String str2) {
//        getDataGif(str, str2);
//    }
//
//    public void getDataGif(String parentId, String moduleId) {
//        this.currentId = parentId;
//        ArrayList arrayList = this.hashMapListGif.get(parentId);
//        if (arrayList != null) {
//            this._listGifTransition.postValue(arrayList);
//            return;
//        }
//        ArrayList arrayList2 = (ArrayList) Hawk.get("TRANSITION" + parentId, new ArrayList());
//        this.hashMapListGif.put(parentId, arrayList2);
//        this.musicUtils.getTransition(parentId, moduleId, new GifTransitionViewModel$getDataGif$2(this, parentId, function0, arrayList2));
//    }
//
